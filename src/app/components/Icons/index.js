export const BarsIcon = ({ className, width = '24px', height = '24px' }) => {
    return (
        <svg
...
// Sidebar Item Icons:
export const HomeIcon = ({ className, width = '24px', height = '24px', fill = '#1f1f1f' }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            height={height}
...
export const AllIcon = ({ className, width = '24px', height = '24px', fill = '#1f1f1f' }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            height={height}
...
export const FavoriteIcon = ({ className, width = '24px', height = '24px', fill = '#1f1f1f' }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            height={height}
...
export const HistoryIcon = ({ className, width = '24px', height = '24px', fill = '#1f1f1f' }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            height={height}
